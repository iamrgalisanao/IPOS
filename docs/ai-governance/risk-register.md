...
| R-005 | Stale documentation can hide actual release readiness and integration scope | Medium | Teams may under-test or over-test the wrong slice of the system | Re-run sync-discovery before major decisions and update governance artifacts after each significant change | Open |
