...
| Queue and sync observability foundation | FR7, NFR4, ADR-010 | Epic 8 / Story 8.11 | `routes/console.php`, queue usage in `app/Jobs/ProcessAccountingOutboxJob.php` | `tests/Feature/Accounting/AccountingOutboxOrchestrationTest.php` | Partially Implemented |
