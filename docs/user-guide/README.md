...
### 1. [Getting Started](file:///Users/teamsolo/Documents/Dev/IPOS/docs/user-guide/01-getting-started.md)
* Learn about the IPOS zero-loss checkout philosophy, core architectural highlights, and the offline-tolerant POS terminal.

### 2. [Login and Access Control](file:///Users/teamsolo/Documents/Dev/IPOS/docs/user-guide/02-login-and-access.md)
* Accessing the system, role assignments, multi-branch switching, and the RBAC permissions matrix.

### 3. [Dashboard Overview](file:///Users/teamsolo/Documents/Dev/IPOS/docs/user-guide/03-dashboard-overview.md)
...
### 4. Module Guides
* **[Data Exports & Tax Reporting](file:///Users/teamsolo/Documents/Dev/IPOS/docs/user-guide/04-module-guides/data-exports-and-tax.md)**: Generate asynchronous BIR E-Journal reports, manage exports, and review 48-hour retention policies.
...
### 7. [Changelog](file:///Users/teamsolo/Documents/Dev/IPOS/docs/user-guide/changelog.md)
