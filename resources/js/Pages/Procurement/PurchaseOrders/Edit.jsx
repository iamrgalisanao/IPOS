...
export default function Edit({ auth, purchaseOrder, suppliers, branches, products }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        order_date: purchaseOrder.order_date.split('T')[0] || purchaseOrder.order_date,
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="font-extrabold text-2xl text-slate-800 leading-tight tracking-tight">Edit Purchase Order</h2>
                        <p className="text-sm text-slate-500 font-medium mt-1">Updating purchase order draft: {purchaseOrder.po_number}</p>
                    </div>
                </div>
            }
        >
