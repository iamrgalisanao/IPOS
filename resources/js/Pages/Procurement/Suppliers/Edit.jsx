...
export default function Edit({ auth, supplier }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('procurement.suppliers.update', supplier.id));
    };
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="font-extrabold text-2xl text-slate-800 leading-tight tracking-tight">Edit Supplier</h2>
                        <p className="text-sm text-slate-500 font-medium mt-1">Modify vendor contact information, terms, or status settings.</p>
                    </div>
                </div>
            }
        >
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 space-y-8">
                        ...
                        <div className="flex items-center gap-4 pb-6 border-b border-slate-100">
                            ...
                            <div>
                                <h3 className="text-lg font-black text-slate-800">Update Supplier Identity</h3>
                                <p className="text-xs text-slate-400 font-medium">Unique identifiers like vendor codes remain tenant-locked.</p>
                            </div>
                        </div>
